      ...
      <Grid item xs={12}>
        <Card>
          ...
          >
            ...
            <PersonalDetailsDialog setSnackBarMsg={setSnackBarMsg} setCurrentUser={setCurrentUser} currentUser={currentUser}/>
      ...
      <Grid item xs={12}>
        <Card>
          ...
          >
            ...
            <AccountSettingsDialog setSnackBarMsg={setSnackBarMsg} setCurrentUser={setCurrentUser} currentUser={currentUser}/>
          </Box>
          <Divider />
          <CardContent sx={{ p: 4 }}>
            <Typography variant="subtitle2">
