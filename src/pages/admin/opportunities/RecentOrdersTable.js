...
const headCells = [
  ...
  {
    id: 'budget.downpayment',
    numeric: true,
    disablePadding: false,
    label: 'Downpayment'
  },
  {
    id: 'budget.installmentAmountDue',
    numeric: true,
    disablePadding: false,
    label: 'installment'
  },
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{row.budget.downpayment}</TableCell>
                    <TableCell>
                      {row.budget.installmentAmountDue} for{' '}
                      {row.budget.totalNumberOfInstallments} Months
                    </TableCell>
